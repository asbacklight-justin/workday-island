...
| --- | --- | --- |
| macOS | `Workday-Island-v0.16.3-macOS-universal.dmg` | macOS 12+, Apple Silicon (M-series) and Intel |
| Windows | `Workday-Island-v0.16.3-windows-x64-Setup.exe` | Windows 10/11 x64; Microsoft Edge WebView2 is required |
